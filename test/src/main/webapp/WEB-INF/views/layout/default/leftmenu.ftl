 ...
 <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                <li id="1" style="display: none;"><a href="/Item.joil?menuname=ItemList"><i class="fa fa-money"></i>품목 관리 <span class="fa fa-chevron-down"></span></a>
                ...
                <li id="2" style="display: none;"><a><i class="fa fa-wrench"></i> 생산 관리 <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    ...
                    <li><a href="/Work.joil?menuname=WorkAllInsert">작업 일괄  등록</a></li>
                ...
                <li id="3" style="display: none;"><a><i class="fa fa-money"></i> 원가 관리 <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    <li><a>원가 관리<span class="fa fa-chevron-down"></span></a>
                    	<ul class="nav child_menu" >
                    		...
                    		<li><a href="/ProductCost.joil?menuname=ProductCostDetail">원가 상세</a></li>
                  		</ul>
                    </li>
                ...
                <li id="4" style="display: none;"><a href="/Inventory.joil?menuname=InventoryList"><i class="fa fa-hdd-o"></i> 재고 관리 <span class="fa fa-chevron-down"></span></a>
                ...
                <li id="5" style="display: none;"><a><i class="fa fa-check-square"></i> 품질 관리 <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    <li>
                    	<a href="/QualityManage.joil?menuname=QualityManageList">품질 관리</a>
                    </li>                    
                  </ul>
                </li>
                 -->
                  ...
                  <ul class="nav child_menu" style="display: none">
                   <!--  <li><a>은행별 잔고현황<span class="fa fa-chevron-down"></span></a>
                    ...
                    <li><a>매출 관리<span class="fa fa-chevron-down"></span></a>
                    	<ul class="nav child_menu">
                    		<li ><a href="/BuyManage.joil?menuname=BuyBook">준비중</a></li>
                    	</ul>
                    </li>                
                  </ul>
                </li>
                ...
                <li id="9" style="display: none;"><a><i class="fa fa-share-alt"></i> 공정 관리 <span class="fa fa-chevron-down"></span></a>
                 ...
                 -->
                <li id="10" style="display: none;"> <a href="/Board.joil?menuname=BoardList"><i class="fa fa-sun-o"></i>자료실<span class="fa fa-chevron-down"></span></a></li>
                <li id="20" style="display: none;"> <a href="/NoticeBoard.joil?menuname=NoticeBoardList"><i class="fa fa-file-text-o"></i>게시판<span class="fa fa-chevron-down"></span></a>
                ...
                <li id="88" style="display: none;">
                <a><i class="fa fa-mail-forward"></i>메일발송<span class="fa fa-chevron-down"></span></a>
                 <ul class="nav child_menu" style="display: none">
                    <li> <!-- class="current-page" -->
                    	<a href="/EmailSend.joil?menuname=EmailSend">메일 발송(급여)</a>
                    </li>
                    <li>
                    	<a href="/EmailSend.joil?menuname=EmailSendBonusList">메일 발송(상여금)</a>
                    </li>                   
                    <li>
                    	<a href="/EmailSend.joil?menuname=EmailCode">메일 코드 관리</a>
                    </li>
                  </ul>
