                    ...
                    <div class="form-group">
                      ...
                      <div class="checkbox ">
                          <label>                            
                          	...
                          	<input type="checkbox" class="flat" name="su_menu_auth" id="su_menu_auth" value="10" <#list UserVo.su_menu_auth?split("|") as job><#if job == '10'>checked</#if></#list>>자료실
                          	...
                          	<input type="checkbox" class="flat" name="su_menu_auth" id="su_menu_auth" value="20" <#list UserVo.su_menu_auth?split("|") as job><#if job == '20'>checked</#if></#list>>게시판
                          	<input type="checkbox" class="flat" name="su_menu_auth" id="su_menu_auth" value="88" <#list UserVo.su_menu_auth?split("|") as job><#if job == '88'>checked</#if></#list>>메일발송
                          </label>
                      </div>
                    </div> 
                     <div class="form-group">
