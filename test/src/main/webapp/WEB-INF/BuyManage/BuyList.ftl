...
$(function() {	 
	  ...
	  <#list List as Info>
	  $("#ab_date${Info.ab_seq!}").datepicker({
		  dateFormat: 'yy-mm-dd',
			monthNamesShort: ['1월','2월','3월','4월','5월','6월','7월','8월','9월','10월','11월','12월'],
		     dayNamesMin: ['일','월','화','수','목','금','토'],
			 changeMonth: true, //월변경가능
                    ...
                    <#list List as Info>
	                    <tr>	                      
	                        ...
	                        <td style="width:112px;" nowrap>	                          
	                          <button onclick="javascript:BuyUpdate('${Info.ab_seq!?replace(',','')}');" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> 수정 </button>
	                          <a href="javascript:deleteCheck('${Info.ab_seq!?replace(',','')}'); " class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> 삭제 </a>
	                        </td>
	                      </tr>
					</#list>
                    </#if>  
