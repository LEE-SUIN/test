                    ...
                    <#list List as Info>
	                    <tr>	                      
	                        ...
	                        <#assign tmp = Info.filelist?size?default(0) >
		                        <#if Info.filelist??>
		                        	<#list Info.filelist as FileInfo>		                        		
				                        <img src="/resources/uploadFile/${menu_name!}/${FileInfo.f_save_name!}" class="avatar" alt="Avatar" onclick="pop(this);" /> 
		                        	</#list>		                        	
		                        </#if>   
		                    </td>    		                                         
	                        <td>
	                       ...
	                       <#--  <td>
	                        ...
	                        <td class="no-print">	                          
	                          <button onclick="location.href='/Item.joil?menuname=ItemUpdate&seq=${Info.pi_seq!?replace(',','')}'" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> 수정 </button>
	                          <a href="javascript:deleteCheck('${Info.pi_seq!?replace(',','')}'); " class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> 삭제 </a>
	                        </td>
	                      </tr>
					</#list>
                    </#if>  
