                   ...
                   <caption><span class="blind">${menutitle!}</span></caption>
                    ...
                    <#list List as Info>
	                    <tr>
	                        ...
	                        <td>	                          
	                          <button onclick="location.href='/OutSide.joil?menuname=OutSideWorkUpdate&seq=${Info.ow_seq!?replace(',','')}'" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> 수정 </button>
	                          <a href="javascript:deleteCheck('${Info.ow_seq!?replace(',','')}'); " class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> 삭제 </a>
	                        </td>
	                      </tr>
					</#list>
                    </#if>  
