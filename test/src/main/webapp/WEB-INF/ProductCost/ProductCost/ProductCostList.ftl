                  ...
                  <ul class="nav navbar-right panel_toolbox">
                    <li>
                    	<div class="input-group" class="col-md-4 col-sm-4 col-xs-4" >
						  ...
						  <input type="text" name="tmp_search_word" id ="tmp_search_word" class="form-control" style="width:160px;" placeholder="품목 또는 업체명" value="${search_word!}">&nbsp;
                   ...
                   <caption><span class="blind">${menutitle!}</span></caption>
                    ...
                    <#list List as Info>
	                    <tr>	                      
	                        ...
	                        <td>	                          
	                          <button onclick="location.href='/ProductCost.joil?menuname=ProductCostUpdate&seq=${Info.pl_seq!?replace(',','')}'" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> 수정 </button>
	                          <a href="javascript:deleteCheck('${Info.pl_seq!?replace(',','')}'); " class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> 삭제 </a>
	                        </td>
	                      </tr>
					</#list>
                    </#if>  
