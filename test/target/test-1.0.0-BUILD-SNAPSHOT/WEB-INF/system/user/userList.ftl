                    ...
                    <#list List as Info>
	                    <tr>	                      
	                        ...
	                        <td>
	                          ...
	                          <button onclick="location.href='/user.joil?menuname=userUpdate&seq=${Info.su_seq!}'" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> 수정 </button>
	                          <a href="javascript:deleteCheck('${Info.su_seq!}');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> 삭제 </a>
	                        </td>
	                      </tr>
